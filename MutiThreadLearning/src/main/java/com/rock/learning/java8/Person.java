...
public class Person {
	...
	public void printWesternName() {
		...
		System.out.println(printCustom(westernStyle));
	}
	...
	public void printEasternName() {
		...
		System.out.println(printCustom(easternStyle));
	}
	...
	public static List<Person> createShortList() {
		...
		people.add(new Person.Builder().givenName("Bob").surName("Backer").age(21).gender(Gender.FEMALE)
				.email("bob.baker@example.com").phoneNumber("65-919182343").address("44 4th St, Smallville, KS 12233")
				.build());

		people.add(new Person.Builder().givenName("Jane").surName("Doe").age(25).gender(Gender.MALE)
				.email("jane.doe@example.com").phoneNumber("202-123-45678").address("33 3rd St, Smallville, KS 123333")
				.build());
